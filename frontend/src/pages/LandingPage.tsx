    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
            ...
            <main className="flex-grow pt-20">
                    ...
                    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="flex flex-col gap-8 text-center lg:text-left z-10">
                            <div className="space-y-4">
                                <h1 className="text-5xl lg:text-7xl font-display font-extrabold tracking-tight text-text-main dark:text-white leading-[1.1]">
                                    Your College Life, <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Organized.</span>
                                </h1>
                                <p className="text-lg lg:text-xl text-text-muted dark:text-gray-400 max-w-2xl mx-auto lg:mx-0 font-body leading-relaxed">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                ...
                                <button className="group bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-text-main dark:text-white text-base font-bold h-14 px-8 rounded-xl hover:border-primary/50 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 flex items-center justify-center gap-2">
                            ...
                            <div className="flex items-center justify-center lg:justify-start gap-4 pt-4">
                                <div className="flex -space-x-3">
                                    ...
                                    <div className="w-10 h-10 rounded-full border-2 border-white dark:border-background-dark bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-xs font-bold text-text-muted">+2k</div>
                                </div>
                        ...
                        <div className="relative lg:h-[600px] flex items-center justify-center lg:justify-end">
                            <div className="relative w-full aspect-[4/3] lg:aspect-square max-w-[500px] lg:max-w-none">
                                ...
                                />
                                {/* Floating Cards */}
                                <div className="absolute top-[20%] left-0 lg:-left-[10%] z-20 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-soft border border-gray-100 dark:border-gray-700 motion-safe:animate-bounce" style={{ animationDuration: '3s' }}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-text-main dark:text-white">Essay Draft</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="absolute bottom-[20%] right-0 lg:right-[0%] z-20 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-soft border border-gray-100 dark:border-gray-700 motion-safe:animate-bounce" style={{ animationDuration: '4s', animationDelay: '1s' }}>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-text-main dark:text-white">$45.00 this week</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                {/* Feature Section */}
                <section className="py-20 bg-white dark:bg-gray-900/50" id="features">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                            <h2 className="text-3xl md:text-4xl font-display font-bold text-text-main dark:text-white">Everything you need to <span className="text-primary">ace the semester</span></h2>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {/* Card 1: Task Mastery */}
                            <a href="#" className="feature-card bg-background-light dark:bg-gray-800 rounded-2xl p-8 border border-gray-100 dark:border-gray-700 flex flex-col h-full relative overflow-hidden group transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                                ...
                                <h3 className="text-xl font-bold text-text-main dark:text-white mb-3 relative z-10">Task Mastery</h3>
                ...
                <section className="py-12 border-t border-gray-100 dark:border-gray-800">
                    <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex flex-col gap-1">
                            <h4 className="text-lg font-bold text-text-main dark:text-white">Ready to organize your life?</h4>
                            <p className="text-sm text-text-muted">Join thousands of students getting more done.</p>
                        </div>
                        <div className="flex gap-4 w-full md:w-auto">
                            <input className="flex-grow md:w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all" placeholder="Enter your .edu email" type="email" />
