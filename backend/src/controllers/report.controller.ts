...
import { z } from 'zod';
import { generateMonthlyReport, generateSpendingReport } from '../services/report.service';
...
export const getSpendingReport = async (req: Request, res: Response) => {
    ...
    const report = await generateSpendingReport(req.user!.userId, startDate, endDate);
